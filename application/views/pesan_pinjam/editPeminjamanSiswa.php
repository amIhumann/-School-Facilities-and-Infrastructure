<div class="card mb-5" style="max-width: 540px; margin:auto; ">
    <div class="row no-gutters">
        ...
        <div class="col-md-12">
            <div class="card-body">
                <form enctype="multipart/form-data" method="POST" action="<?= base_url('peminjaman/updateSiswa'); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select" name="id_peminjam" id="inputGroupSelect01">
                                <?php foreach ($siswa as $jur) : ?>
                                    <option value="<?php echo $jur->id_peminjam; ?>" <?php if ($jur->id_peminjam == $ad->id_peminjam) echo 'selected'; ?>><?php echo $jur->nama_siswa; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div><br>
                        <div class="input-group mb-3">
