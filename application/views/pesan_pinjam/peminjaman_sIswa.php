                ...
                <tbody>
                    ...
                    foreach ($peminjaman as $ad) : ?>
                        <tr>
                            ...
                            <td><?php echo $ad->status ?><?php if($ad->status=='pinjam'){ ?> <a href="<?php echo base_url('peminjaman/kembaliSiswa/' . $ad->id_peminjaman); ?>"><button class="btn-info btn"><i class="fa fa-archive"></i></button></a><?php }?></td>
                            <td>
                                <a href="<?php echo base_url('peminjaman/editSiswa/' . $ad->id_peminjaman); ?>"><button style="margin:5px;" title="Edit" class="btn-success btn"><i class="fa fa-edit"></i></button>
                                    <a href="<?php echo base_url('peminjaman/hapusSiswa/' . $ad->id_peminjaman); ?>" onclick="return confirm('Yakin untuk menghapus?');"><button style="margin:5px;" title="Hapus" class="btn-danger btn"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="<?= base_url('peminjaman/tambahSiswa') ?>" method="POST">
