                ...
                <tbody>
                    ...
                    foreach ($peminjam as $ad) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('peminjam/edit/' . $ad->id_peminjam); ?>"><button style="margin:5px;" title="Edit" class="btn-success btn"><i class="fa fa-edit"></i></button>
                                    <a href="<?php echo base_url('peminjam/hapus/' . $ad->id_peminjam); ?>" onclick="return confirm('Yakin untuk menghapus?');"><button style="margin:5px;" title="Hapus" class="btn-danger btn"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data" action="<?= base_url('peminjam/tambah') ?>" method="POST">
